...
function AddVideo({ setVideos, setVideoDownloading }) {
    ...
    return (
        <>
            {isShowModal && <ModalUploadVideo setVideos={setVideos} setIsShowModal={setIsShowModal} setVideoDownloading={setVideoDownloading} />}
