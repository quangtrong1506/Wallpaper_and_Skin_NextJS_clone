export default function BottomButton({ scale = 1, text, icon = 0 }: { scale?: number; text: string; icon: 0 | 1 }) {
    return (
        <div
            className="relative border-[rgba(255,255,255,0.6)] border-solid border-2 border-t-transparent box-border bg-[rgba(0,0,0,0.2)] select-none"
            style={{
                width: 300 * scale + 'px',
                height: 84 * scale + 'px',
            }}
        >
            <div className="absolute h-[85%] w-[96%] top-[7.5%] left-[2%] box-border border-b-4 border-[#34d6ff] bg-gradient-to-t from-[#34d6ff6a] to-transparent"></div>
            <div
            ...
            >
                {icon === 0 && (
                    <svg className="w-full" fill="#ffffffd0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
                        <path
                            className="cls-1"
                ...
                {icon === 1 && (
                    <svg className="w-full" fill="#ffffffd0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 494 317">
                        <path
                            className="cls-1"
            ...
            <div className="absolute h-[2px] w-[240px] bg-[rgba(255,255,255,0.6)] -left-[2px] -top-[2px]"></div>
            <div className="absolute h-[2px] w-[20px] bg-[rgba(255,255,255,0.6)] -right-[2px] -top-[2px]"></div>
            <div className="absolute h-[6px] w-[36px] bg-[#34d6ff] right-[20px] -top-[4px]"></div>
        </div>
    );
}
